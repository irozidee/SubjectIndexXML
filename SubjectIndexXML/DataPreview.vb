...
Public Class DataPreview
    ...
    Private Sub dataGrid_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dataGrid.CellContentDoubleClick
        Dim datafilename As String = dataGrid.Item(0, e.RowIndex).Value
        ...
        ElseIf DatabaseSelection = "v_legislations" Then
            ...
            value2 = dataGrid.Item("legis_filename", e.RowIndex).Value
        ...
        ElseIf DatabaseSelection = "v_subject_index" Then
            value1 = dataGrid.Item(1, e.RowIndex).Value
            value2 = dataGrid.Item(2, e.RowIndex).Value
            value3 = dataGrid.Item(3, e.RowIndex).Value
            value4 = dataGrid.Item(4, e.RowIndex).Value
        Else
